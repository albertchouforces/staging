  ...
  const renderItem = useCallback((item: ParsedItem, isLeft: boolean) => {
    ...
    if (item.type === 'text') {
      return (
        ...
        >
          <div className="font-medium select-none pointer-events-none [&_ul]:list-disc [&_ul]:ml-6 [&_ul]:my-2 [&_ol]:list-decimal [&_ol]:ml-6 [&_ol]:my-2 [&_li]:mb-1" dangerouslySetInnerHTML={{ __html: item.value as string }} />
