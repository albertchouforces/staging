      ...
      <div className="flex flex-col w-full">
        ...
        {showResult && (
          <div className="w-full p-6 flex flex-col gap-6">
            ...
            {question.fact && (
              <div className="p-4 rounded-lg border max-w-xl mx-auto" style={{ backgroundColor: colors.light, borderColor: colors.border }}>
                <div className="flex items-center gap-2 mb-2" style={{ color: colors.text }}>
                  <BookOpen size={20} />
                  <span className="font-semibold">Did you know?</span>
                </div>
                <p style={{ color: colors.text }}>{question.fact}</p>
              </div>
            )}
          </div>
        )}
